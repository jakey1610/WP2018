			...
			success: (data)=>{
				$.ajax({
					...
					success: (data1)=>{
						var uP = data;
						var uSSet = data1;
						var message = "<script src = '../js/likeClick.js'></script>";
			    		...
			    		$('#recent-posts-box').html("<h1>Recent Posts</h1>"+message);
					}
				});
