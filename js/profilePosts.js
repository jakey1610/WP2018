					...
					success: (data1)=>{
			    		...
			    		for(var object in uP){
			    			if(uP[object]['user'] == username.trim()){
			    				message += '<div class="media" style = "margin-top:3%; float:bottom;"><div class="media-left media-middle"><a href="#"><img class="media-object" src="../' + uS['ppicture'] +'" alt="Profile Picture Example" height = 50, width = 50></a></div><div class="media-body"><h4 class="media-heading"><a href = "#">' +  uP[object]['user'] + '</a></h4>' + uP[object]['content'] + '</div><button class = "btn-info like-button" id = "like' + uP[object]['postID'] + '"><span class = "glyphicon glyphicon-thumbs-up" aria-hidden="true" style = "color:white;margin-left:10%;" ></span></button><p class = "likeCounter">' + uP[object]['likes'] + '</p></div>';
			    			}
			    		}
